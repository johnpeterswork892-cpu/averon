  ...
  <div className="flex flex-col md:flex-row gap-4">
    <div className="flex-1">
      <input
        ...
        className="w-full h-14 px-6 text-lg border-2 border-gray-200 text-primary-900 rounded-xl focus:border-accent-500 focus:outline-none transition-colors"
        maxLength={10}
      />
    ...
    <button
      ...
      className="h-14 px-8 bg-accent-500 text-white font-semibold rounded-xl hover:bg-accent-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-lg disabled:hover:shadow-none flex items-center justify-center"
    >
      {isLoading ? (
